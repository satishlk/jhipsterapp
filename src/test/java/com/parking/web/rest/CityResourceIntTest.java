...
public class CityResourceIntTest {
    ...
    public void setup() {
        ...
        CityResource cityResource = new CityResource(cityRepository);
    ...
    public void getAllCities() throws Exception {
        ...
        restCityMockMvc.perform(get("/api/cities?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].cityDescription").value(hasItem(DEFAULT_CITY_DESCRIPTION.toString())));
    }
    ...
    public void getCity() throws Exception {
        ...
        restCityMockMvc.perform(get("/api/cities/{id}", city.getId()))
            ...
            .andExpect(jsonPath("$.cityDescription").value(DEFAULT_CITY_DESCRIPTION.toString()));
    }
